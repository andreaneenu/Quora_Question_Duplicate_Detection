...
- Tested various models including Logistic Regression, Linear SVM, and XGBoost; found that the hyperparameter-tuned XGBoost achieved the best performance with a Log Loss of 0.362.
